...
// JavaScript Document
        ...
        const imageData = [
            {
                title: "BMW M4 Performance",
                description: "A neon green BMW M4 drifting against a night sky with purple smoke, showcasing bold style and precision"
            },
            {
                title: "BMW M4 Performance",
                description : "A neon green BMW M4 drifting against a night sky with purple smoke, showcasing bold style and precision"
            ...
            {
                title: "Porsche 911 Drift",
                description: "A sleek white Porsche 911 tearing through smoke with fiery red skies, embodying speed and adrenaline"
            },
            {
                title: "Koenigsegg Agera Power",
                description: "The red Agera launches forward with green-yellow streaks in the sky, symbolizing raw hypercar performance"
            },
            {
                title: "BMW M4 Performance",
                description: "A neon green BMW M4 drifting against a night sky with purple smoke, showcasing bold style and precision"
            ...
            {
                title: "BMW M5 Beast",
                description: "A bold BMW M5 charging with raw aggression, blending luxury and high-performance dominance on the road"
            },
            {
                title: "Rolls-Royce Elegance",
                description: "The iconic Rolls-Royce glides with unmatched luxury, reflecting timeless class and a royal driving presence"
            },
            {
                title: "McLaren P1 Speed",
                description: "The golden-yellow McLaren P1 powers through fiery orange tracks, a symbol of futuristic design and speed"
            },
            {
                title: "Mustang Muscle Drift",
                description: "A white Mustang GT500 with bold stripes, sliding through glowing pink smoke under a vibrant purple sky"
            }
        ];
